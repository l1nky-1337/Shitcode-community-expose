...
bool ImGui::TabButtonEx(const char* ico, const char* label, const ImVec2& size_arg, ImGuiButtonFlags flags)
{
   ...
   // window->DrawList->AddRectFilledMultiColor(bb.Min + ImVec2(0.000f, 0.000f), bb.Max + ImVec2(bb.Min.x - bb.Min.x - 20, bb.Min.y - bb.Min.y), ImColor(it_nameanim->second, 0.200f, 0.200f, 0.100f), ImColor(0.00f, 0.00f, 0.00f, 0.000f), ImColor(0.00f, 0.00f, 0.00f, 0.000f), ImColor(it_nameanim->second, 0.200f, 0.200f, 0.100f));
    ...
    if (tab_count == 0 && label == "Aimbot") window->DrawList->AddRectFilledMultiColor(ImVec2(0.000f + pos.x, 0.000f + pos.y), ImVec2(gradient_line + pos.x, 40 + pos.y), ImColor(accent_color[0], accent_color[1], accent_color[2]), ImColor(accent_color[0], accent_color[1], accent_color[2]), ImColor(accent_color[0], accent_color[1], accent_color[2]), ImColor(accent_color[0], accent_color[1], accent_color[2], 1.100f));
  ...
  //  if (tab_count == 2 && label == "AntiAim") window->DrawList->AddRectFilledMultiColor(ImVec2(0.000f + pos.x, 0.000f + pos.y), ImVec2(gradient_line + pos.x, 40 + pos.y), ImColor(accent_color[0], accent_color[1], accent_color[2], 0.100f), ImColor(accent_color[0], accent_color[1], accent_color[2], 0.000f), ImColor(accent_color[0], accent_color[1], accent_color[2], 0.000f), ImColor(accent_color[0], accent_color[1], accent_color[2], 0.100f));
    ...
    if (tab_count == 1 && label == "Visuals") window->DrawList->AddRectFilledMultiColor(ImVec2(0.000f + pos.x, 0.000f + pos.y), ImVec2(gradient_line + pos.x, 40 + pos.y), ImColor(accent_color[0], accent_color[1], accent_color[2]), ImColor(accent_color[0], accent_color[1], accent_color[2]), ImColor(accent_color[0], accent_color[1], accent_color[2]), ImColor(accent_color[0], accent_color[1], accent_color[2], 1.100f));

    if (tab_count == 2 && label == "Misc") window->DrawList->AddRectFilledMultiColor(ImVec2(0.000f + pos.x, 0.000f + pos.y), ImVec2(gradient_line + pos.x, 40 + pos.y), ImColor(accent_color[0], accent_color[1], accent_color[2]), ImColor(accent_color[0], accent_color[1], accent_color[2]), ImColor(accent_color[0], accent_color[1], accent_color[2]), ImColor(accent_color[0], accent_color[1], accent_color[2], 1.100f));

    if (tab_count == 3 && label == "Design") window->DrawList->AddRectFilledMultiColor(ImVec2(0.000f + pos.x, 0.000f + pos.y), ImVec2(gradient_line + pos.x, 40 + pos.y), ImColor(accent_color[0], accent_color[1], accent_color[2]), ImColor(accent_color[0], accent_color[1], accent_color[2]), ImColor(accent_color[0], accent_color[1], accent_color[2]), ImColor(accent_color[0], accent_color[1], accent_color[2], 1.100f));

    if (tab_count == 4 && label == "Exploit")window->DrawList->AddRectFilledMultiColor(ImVec2(0.000f + pos.x, 0.000f + pos.y), ImVec2(gradient_line + pos.x, 40 + pos.y), ImColor(accent_color[0], accent_color[1], accent_color[2]), ImColor(accent_color[0], accent_color[1], accent_color[2]), ImColor(accent_color[0], accent_color[1], accent_color[2]), ImColor(accent_color[0], accent_color[1], accent_color[2], 1.100f));

   // if (tab_count == 5 && label == "Script") window->DrawList->AddRectFilledMultiColor(ImVec2(0.000f + pos.x, 0.000f + pos.y), ImVec2(gradient_line + pos.x, 40 + pos.y), ImColor(accent_color[0], accent_color[1], accent_color[2], 0.100f), ImColor(accent_color[0], accent_color[1], accent_color[2], 0.000f), ImColor(accent_color[0], accent_color[1], accent_color[2], 0.000f), ImColor(accent_color[0], accent_color[1], accent_color[2], 0.100f));

    if (tab_count == 5 && label == "Config") window->DrawList->AddRectFilledMultiColor(ImVec2(0.000f + pos.x, 0.000f + pos.y), ImVec2(gradient_line + pos.x, 40 + pos.y), ImColor(accent_color[0], accent_color[1], accent_color[2]), ImColor(accent_color[0], accent_color[1], accent_color[2]), ImColor(accent_color[0], accent_color[1], accent_color[2]), ImColor(accent_color[0], accent_color[1], accent_color[2], 1.100f));
