...
//		{
//			return (0.6f - (((float)elapsed - (float)NOTIFY_FADE_IN_OUT_TIME - (float)this->dismiss_time) / (float)NOTIFY_FADE_IN_OUT_TIME)) * NOTIFY_OPACITY;
//		}
//
//		return 0.6f * NOTIFY_OPACITY;
//	}
//
//public:
//	// Constructors
...
//
//		float height = 0.f;
//		auto& style_notif = ImGui::GetStyle();
//		style_notif.FrameBorderSize = 1.f;
//		style_notif.FrameRounding = 0.f;
//		style_notif.FramePadding = ImVec2(4.f, 0.f);
//		style_notif.GrabRounding = 3.f;
//		style_notif.TabRounding = 0.f;
//		style_notif.TabBorderSize = 1.f;
//		style_notif.ScrollbarSize = 3.f;
//		style_notif.WindowTitleAlign.x = 0.50f;
